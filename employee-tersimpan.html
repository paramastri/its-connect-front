...
<html lang="en">
  <head>
    ...
    <title>myITS Connect - Calon Pegawai Tersimpan</title>
        ...
        <ul class="nav nav-aside">
          ...
          <li class="nav-item with-sub show active">
            ...
            <ul>
              ...
              <li class="active"><a href="employee-tersimpan.html">Calon Pegawai Tersimpan</a></li>
          ...
          <div class="content-body">
            <div class="container pd-x-0">
              <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
                <div>
                  <h4 class="mg-b-0 tx-spacing--1">Calon Pegawai Tersimpan</h4>
                </div>
              </div>
          ...
          <div class="col-lg-8 col-xl-12">
            ...
            <div class="row row-sm mg-b-25">
              <div style="margin-bottom: 20px;" class="col-md-4">
                <div class="card">
                  <div class="card-body tx-13">
                    <div style="margin-bottom: 10px;" class="avatar"><span class="avatar-initial rounded-circle bg-facebook">EI</span></div>
                    <h5><a>Ersad Ahmad Islahuddin</a></h5>
                    <p class="mg-b-0">Fresh Graduate ITS</p>
                    <span class="tx-12 tx-color-03">Bojonegoro, Indonesia</span>
                  </div><!-- card-body -->
                  <div style="float: right;" class="card-footer tx-13">
                    <span></span>
                    <button class="btn btn-xs btn-secondary">Batalkan Penyimpanan</button>
                  </div><!-- card-footer -->
                </div><!-- card -->
              </div><!-- col -->
              ...
              <div style="margin-bottom: 20px;" class="col-md-4">
                <div class="card">
                  <div class="card-body tx-13">
                    <div style="margin-bottom: 10px;" class="avatar"><span class="avatar-initial rounded-circle bg-facebook">JD</span></div>
                    <h5><a>Jaler Dio</a></h5>
                    <p class="mg-b-0">Fresh Graduate ITS</p>
                    <span class="tx-12 tx-color-03">Bogor, Indonesia</span>
                  </div><!-- card-body -->
                  <div style="float: right;" class="card-footer tx-13">
                    <span></span>
                    <button class="btn btn-xs btn-secondary">Batalkan Penyimpanan</button>
              ...
              <div style="margin-bottom: 20px;" class="col-md-4">
                <div class="card">
                  <div class="card-body tx-13">
                    <div style="margin-bottom: 10px;" class="avatar"><span class="avatar-initial rounded-circle bg-facebook">BN</span></div>
                    <h5><a>Bintang Nuralamsyah</a></h5>
                    <p class="mg-b-0">Fresh Graduate ITS</p>
                    <span class="tx-12 tx-color-03">Jember, Indonesia</span>
                  </div><!-- card-body -->
                  <div style="float: right;" class="card-footer tx-13">
                    <span></span>
                    <button class="btn btn-xs btn-secondary">Batalkan Penyimpanan</button>
              ...
              <div style="margin-bottom: 20px;" class="col-md-4">
                <div class="card">
                  <div class="card-body tx-13">
                    <div style="margin-bottom: 10px;" class="avatar"><span class="avatar-initial rounded-circle bg-facebook">AD</span></div>
                    <h5><a>Adin Ningrum</a></h5>
                    <p class="mg-b-0">Fresh Graduate ITS</p>
                    <span class="tx-12 tx-color-03">Sidoarjo, Indonesia</span>
                  </div><!-- card-body -->
                  <div style="float: right;" class="card-footer tx-13">
                    <span></span>
                    <button class="btn btn-xs btn-secondary">Batalkan Penyimpanan</button>
              ...
              <div style="margin-bottom: 20px;" class="col-md-4">
                <div class="card">
                  <div class="card-body tx-13">
                    <div style="margin-bottom: 10px;" class="avatar"><span class="avatar-initial rounded-circle bg-facebook">TN</span></div>
                    <h5><a>Thisa Nabil</a></h5>
                    <p class="mg-b-0">Fresh Graduate ITS</p>
                    <span class="tx-12 tx-color-03">Bandung, Indonesia</span>
                  </div><!-- card-body -->
                  <div style="float: right;" class="card-footer tx-13">
                    <span></span>
                    <button class="btn btn-xs btn-secondary">Batalkan Penyimpanan</button>
