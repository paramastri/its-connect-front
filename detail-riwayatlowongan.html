...
<html lang="en">
  <head>
    ...
    <title>myITS Connect - Detail Riwayat Lowongan</title>
            ...
            <div>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                  <li class="breadcrumb-item"><a href="riwayat-lowongan.html">riwayat lowongan</a></li>
                  <li class="breadcrumb-item active" aria-current="page">detail riwayat lowongan</li>
                </ol>
              </nav>
              <h4 class="mg-b-0 tx-spacing--1">UI/UX Designer</h4>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mg-b-10 mg-sm-b-0 mg-t-20">
                    ...
                    <div class="row row-sm">
                      <div class="col-sm-12">
                        <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-20">deskripsi pekerjaan</label>
                        <p class="tx-semibold mg-b-0 tx-13 tx-color-02 mg-b-5 mg-l-20">Kualifikasi:</p>
                        <ul class="">
                        <li>Mahasiswa S1 semester (5 - akhir) atau mahasiswa S2 yang ingin bergabung</li>
                        <li>Memiliki kemampuan komunikasi dan kerjasama yang baik dalam tim</li>
                        <li>Memiliki nilai untuk bekerja dengan compassion, courage & curious</li>
                        <li>Waktu magang 3 (tiga) bulan</li>
                      </ul>
                      <p class="tx-semibold mg-b-0 tx-13 tx-color-02 mg-b-5 mg-l-20">Tanggung Jawab:</p>
                      <p class="mg-l-20">Melakukan riset guna mengetahui kebiasaan dan kebutuhan para pengguna yang diimplementasikan pada platform untuk dapat mengakses produk/service di Ikigai Consulting. Mengkonsep bagaimana alur suatu produk terasa nyaman digunakan oleh pengguna untuk meningkatkan branding dan sales Membuat tampilan website/flatform Ikigai Consulting agar terlihat lebih menarik dan mudah dipahami oleh pengguna.</p>
                      </div>
                      <div class="col-sm-12">
                      ...
                      <div class="col-sm-12 mg-t-10">
                        ...
                        <ol class="pd-l-10 mg-0 mg-t-10 mg-l-20 mg-b-20 tx-13">
                      ...
                      <div class="col-sm-12 mg-t-40 demo-btn-group">
                            <button type="submit" class="btn btn-secondary align-items-center mg-r-5"><i data-feather="chevron-left"></i><span class="d-none d-sm-inline mg-l-5"> Kembali</span></button>
                            <button style="color: white; background: #013880; outline-color: #013880" type="submit" class="btn align-items-center mg-r-5"><i data-feather="edit"></i><span class="d-none d-sm-inline mg-l-5"> Ubah Lowongan</span></button>
                      </div>
                    </div><!-- row -->
                  </div>
                </div><!-- card-body -->
