            ...
            <div class="media-body mg-t-40 mg-lg-t-0 pd-lg-x-10">
              ...
              <div class="profile-update-option bg-white ht-50 bd d-flex justify-content-end mg-b-20 mg-lg-b-25 rounded">
                <div class="d-flex align-items-center pd-x-20 mg-r-auto">
                  <i data-feather="edit-3"></i> <a href="#modalEditContact" data-toggle="modal" class="link-03 mg-l-10"><span class="d-none d-sm-inline">Apa yang ingin</span> anda bagikan?</a>
                </div>
                <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
                  <a href="" class="link-03" data-toggle="tooltip" title="Unggah Foto"><i data-feather="image"></i></a>
                </div>
                <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
                  <a href="" class="link-03" data-toggle="tooltip" title="Bagikan Tautan"><i data-feather="link"></i></a>
                </div>
                <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
                  <a href="" class="link-03" data-toggle="tooltip" title="Unggah Dokumen"><i data-feather="file-text"></i></a>
                </div>
              </div>
                ...
                <div class="card-body pd-20 pd-lg-25">
                  <div class="media align-items-center mg-b-20">
                    ...
                    <div class="media-body pd-l-15">
                      <h6 class="mg-b-3">Nora Zoey</h6>
                      <span class="d-block tx-13 tx-color-03">Founder of PT. XYZ</span>
                    </div>
              ...
              <div class="card mg-b-20 mg-lg-b-25">
                <div class="card-body pd-20 pd-lg-25">
                  <div class="media align-items-center mg-b-20">
                    <div class="avatar avatar-online"><img src="https://via.placeholder.com/500" class="rounded-circle" alt=""></div>
                    <div class="media-body pd-l-15">
                      <h6 class="mg-b-3">Liam Payne</h6>
                      <span class="d-block tx-13 tx-color-03">Business Expert</span>
                    </div>
                    <span class="d-none d-sm-block tx-12 tx-color-03 align-self-start">5 hours ago</span>
                  </div><!-- media -->
                  <p class="">Our team is expanding again. We are looking for a Product Manager and Software Engineer to drive our new aspects of our capital projects. If you're interested, please drop a comment here or simply message me. <a href="">#softwareengineer</a> <a href="">#engineering</a></p>
                </div>
                <div class="card-footer bg-transparent pd-y-10 pd-sm-y-15 pd-x-10 pd-sm-x-20">
                  <nav class="nav nav-with-icon tx-13">
                    <a href="" class="nav-link"><i data-feather="thumbs-up"></i> Like</a>
              ...
              <div class="row">
                <div class="col-sm-6 col-md-5 col-lg">
                  <div class="d-flex align-items-center justify-content-between mg-b-20">
                    <h6 class="tx-13 tx-uppercase tx-semibold mg-b-0">lowongan untuk anda</h6>
                  </div>
                  <ul class="list-unstyled media-list mg-b-15">
                    <li class="media align-items-center">
                      ...
                      <div class="media-body pd-l-15">
                        <p class="tx-medium mg-b-2"><a href="" class="link-01">UI/UX Designer</a></p>
                        <span class="tx-12 tx-color-03">PT. Aris Wijaya</span>
                      </div>
                    </li>
                    <li class="media align-items-center">
                      <a href=""><div class="avatar"><img src="https://via.placeholder.com/500" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                        <p class="tx-medium mg-b-2"><a href="" class="link-01">Senior Business Analyst</a></p>
                        <span class="tx-12 tx-color-03">Tokopedia Indonesia</span>
                      </div>
                    </li>
                    <li class="media align-items-center">
                      <a href=""><div class="avatar"><img src="https://via.placeholder.com/500" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                        <p class="tx-medium mg-b-2"><a href="" class="link-01">Product Designer</a></p>
                        <span class="tx-12 tx-color-03">Blibli.com</span>
                      </div>
                    </li>
                    <li class="media align-items-center">
                      <a href=""><div class="avatar"><img src="https://via.placeholder.com/500" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                        <p class="tx-medium mg-b-2"><a href="" class="link-01">UX Writer</a></p>
                        <span class="tx-12 tx-color-03">Tiket.com</span>
                      </div>
                    </li>
                    <li class="media align-items-center">
                      <a href=""><div class="avatar"><img src="https://via.placeholder.com/500" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                        <p class="tx-medium mg-b-2"><a href="" class="link-01">Front-end Engineer</a></p>
                        <span class="d-block tx-12 tx-color-03">Pertamina</span>
                      </div>
                    </li>
                  </ul>
                </div><!-- col --> 
                <div class="col-sm-6 col-md-5 col-lg mg-t-40">
                  <div class="d-flex align-items-center justify-content-between mg-b-20">
                    <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">yang Mungkin Anda Kenal</h6>
                  </div>
                  <ul class="list-unstyled media-list mg-b-15">
                    <li class="media align-items-center">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body pd-20 pd-sm-30">
            ...
            <h5 class="tx-18 tx-sm-20 mg-b-20">Buat Postingan</h5>

            <div class="d-sm-flex">
              <div class="flex-fill">
                <textarea class="form-control" rows="2" placeholder="Apa yang ingin anda bagikan?"></textarea>
                <button type="button" class="btn btn-xs btn-light rounded-pill mg-t-10"><i data-feather="image"></i><span class="d-none d-sm-inline mg-l-5">Gambar</span></button>
                <button type="button" class="btn btn-xs btn-light rounded-pill mg-t-10"><i data-feather="link"></i><span class="d-none d-sm-inline mg-l-5">Tautan</span></button>
                <button type="button" class="btn btn-xs btn-light rounded-pill mg-t-10"><i data-feather="file-text"></i><span class="d-none d-sm-inline mg-l-5">Dokumen</span></button>
              </div><!-- col -->
            </div>
          </div>
          <div class="modal-footer">
            <div class="wd-100p d-flex flex-column flex-sm-row justify-content-end">
              ...
              <button type="button" class="btn btn-primary mg-b-5 mg-sm-b-0">Posting Sekarang</button>
            </div>
          </div><!-- modal-footer -->
        </div><!-- modal-content -->
      </div><!-- modal-dialog -->
