				...
				*/
				$(".count-chars").keyup(function () {
					...
					if (charInputLength >= maxChars) {
						...
						remainingMessage = "maks. 150 karakter";
					} else {
						remainingMessage = (charInputLength) + "/150";
					}
					...
					if($("#" + messageDivId).length == 0) {
					  ...
					  $('#'+inputId).after('<div id="'+messageDivId+'" class="text-'+messageColor+' font-weight-light">'+remainingMessage+'</div>');
					}
					else{
					  //update div message 
