...
<html lang="en">
  <head>
    ...
    <title>myITS Connect - Cari Calon Pegawai</title>
      ...
      <div class="aside-body">
        <ul class="nav nav-aside">
          ...
          <li class="nav-item with-sub active show">
            ...
            <ul>
              <li class="active"><a href="employee.html">Cari Calon Pegawai</a></li>
        ...
        <div class="chat-wrapper chat-wrapper-two">
            ...
            <div class="chat-sidebar-body">
              <div class="flex-fill pd-y-20 pd-x-10">
                <div id="chatDirectMsg" class="chat-msg-list">
                  <a href="#" class="media">
                    <div class="avatar avatar-md avatar-online"><span class="avatar-initial bg-facebook rounded-circle">EI</span></div>
                    <div class="media-body mg-l-10">
                      <h6 class="mg-b-3">Ersad Islahudin</h6>
                      <h6 class="mg-b-0 tx-color-03 tx-12">Fresh Graduate ITS</h6>
                      <small class="d-block tx-color-04">Bojonegoro</small>
                    </div><!-- media-body -->
                  </a><!-- media -->
                  <a href="#" class="media">
                    <div class="avatar avatar-md avatar-online"><span class="avatar-initial bg-success rounded-circle">bn</span></div>
                    <div class="media-body mg-l-10">
                      <h6 class="mg-b-3">Bintang Nur</h6>
                      <h6 class="mg-b-0 tx-color-03 tx-12">Fresh Graduate ITS</h6>
                      <small class="d-block tx-color-04">Jember</small>
                    </div><!-- media-body -->
                  </a><!-- media -->
                  <a href="#" class="media">
                    <div class="avatar avatar-md avatar-online"><span class="avatar-initial bg-pink rounded-circle">pm</span></div>
                    <div class="media-body mg-l-10">
                      <h6 class="mg-b-3">Paramastri</h6>
                      <h6 class="mg-b-0 tx-color-03 tx-12">Fresh Graduate ITS</h6>
                      <small class="d-block tx-color-04">Sidoarjo</small>
                    </div><!-- media-body -->
                  </a><!-- media -->
                  <a href="#" class="media">
                    <div class="avatar avatar-md avatar-online"><span class="avatar-initial bg-dark rounded-circle">jd</span></div>
                    <div class="media-body mg-l-10">
                      <h6 class="mg-b-3">Jaler Dio</h6>
                      <h6 class="mg-b-0 tx-color-03 tx-12">Fresh Graduate ITS</h6>
                      <small class="d-block tx-color-04">Bogor</small>
                    </div><!-- media-body -->
                  </a><!-- media -->
                </div><!-- media-list -->
              </div>
          ...
          <div class="chat-content">
            <div class="chat-content-header">
              <h6 class="mg-b-0 tx-semibold">Detail Lowongan</h6>
              ...
              <div class="tab-content">
                <div id="contactInformation" class="tab-pane show active pd-20 pd-xl-25">
                  <div class="d-flex align-items-center justify-content-between mg-b-25">
                    <div class="avatar avatar-lg"><span class="avatar-initial rounded-circle bg-facebook">EI</span></div>
                    <div class="d-flex">
                      <a href="#modalEditContact" data-toggle="modal" class="btn btn-sm btn-white d-flex align-items-center mg-r-5"><i data-feather="user"></i><span class="d-none d-sm-inline mg-l-5"> Lihat Profil</span></a>
                      <a href="#modalDeleteContact" data-toggle="modal" class="btn btn-sm btn-white d-flex align-items-center"><i data-feather="save"></i><span class="d-none d-sm-inline mg-l-5">Simpan</span></a>
                    </div>
                  </div> 


                    <div class="media-body">
                      <h4 class="mg-b-3">Ersad Islahudin</h4>
                      <h6 class="mg-b-0 tx-color-03 mg-t-5">Fresh Graduate, ITS</h6>
                      <small class="d-block tx-color-03 mg-t-5">Terbuka untuk pekerjaan baru</small>
                    </div><!-- media-body --> 

                  <div class="row row-sm">
                    <div class="col-sm-12 mg-t-20 mg-sm-t-30">
                      <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Keahlian</label>
                    ...
                    <div class="col-sm-12 mg-t-10 ">
                      <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Pengalaman</label>
                      <div class="media d-block d-sm-flex">
                        <div class="wd-50 ht-50 bg-ui-04 rounded d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-sm-12 mg-t-20 mg-sm-t-30">
                      <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Pendidikan</label>
                      <div class="media d-block d-sm-flex">
                        <div class="wd-50 ht-50 bg-ui-04 rounded d-flex align-items-center justify-content-center">
