...
<html lang="en">
  <head>
    ...
    <title>myITS Connect - Riwayat Lowongan</title>
      ...
      <div class="content-body">
        <div class="container pd-x-0">
          <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
              <h4 class="mg-b-0 tx-spacing--1">Riwayat Lowongan</h4>
            </div>
          </div>
                  ...
                  <table class="table table-dashboard mg-b-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class=" tx-success">Terposting</td>
                        <td class="tx-medium "><a href="">Lihat Detail</a></td>
                      </tr>
                      <tr>
                        <td class="tx-color-03 tx-normal">03/05/2018</td>
                        <td class="">Content Manager</td>
                        <td class="">Magang</td>
                        <td class=" tx-gray-600">Draft</td>
                        <td class="tx-medium "><a href="">Lihat Detail</a></td>
                      </tr>
                      <tr>
                        <td class="tx-color-03 tx-normal">03/05/2018</td>
